...
export class FormularioRecebimentoComponent implements OnInit, IFormularioCanDeactivate {
  ...
  podeMudarRota() {
    ...
    let caixaDialogo = confirm('Tem certeza que deseja sair dessa página?' +
      'As modificações não serão salvas!');

      // se o usuário clicar em ok, é perdido as informações alteradas e redirecionado para nova página
